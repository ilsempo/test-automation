...
def add_products_to_cart(driver):
    ...
    all_add_to_cart_buttons = safe_find_element(driver, By.XPATH, inventory_locators["add_to_cart_buttons"])
...
def user_sorts_by(driver, page, criteria):
    ...
    if criteria in ("sort_az", "sort_za"):
        ...
        item_names_or_prices = safe_find_element(driver, By.XPATH, locators["item_price"])
